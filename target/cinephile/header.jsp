...
<body>
 <ul>
      ...
      <%
				...
				%>
				<li class="nav-list"><a  href="movie-form.jsp">Add Movie</a>
				</li>
				<li class="nav-list"><a  href="LogoutServlet">Log Out</a>
				</li>
		...
		<li class="nav-list">
        <a href="#" class="adj"
          ><img alt="image" src="https://img.myloview.com/posters/user-icon-vector-male-person-profile-avatar-symbol-in-circle-flat-color-glyph-pictogram-illustration-700-140985839.jpg" class="avatar-2" id="view_image"
        /></a>
        <ul class="dropdown">
          <li class="dropdown-list"><a href="LogoutServlet">Log Out</a></li>
          <li class="dropdown-list">
           <a href="ShowUserDetailsServlet?email=<%= loggedInEmail %>">Personal Details</a>

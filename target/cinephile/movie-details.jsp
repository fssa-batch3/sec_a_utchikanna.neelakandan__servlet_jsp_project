   ...
   <div class="firstBox">
      <div>
        ...
        <div class="left">
          ...
          <hr />
          <h2>
            <b>Rating:</b> <span id="rateOfTheMovie">${average.average_rating}</span><span>/5</span
            ><span id="count">${average.rating_count}</span>
          </h2>
          <hr />
          ...
          <p>
            <b>Director:</b
            ><a href="<%=movieDetails.getDirectorWiki()%>" id="directorLink"><span id="directorName"><%=movieDetails.getDirectorName() %></span></a>
          </p>
          <hr />
        </div>
      </div>

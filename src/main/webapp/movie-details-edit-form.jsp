...
<div class="card">
  <div class="card-header">
    <div class="text-header">Edit Movie Details</div>
  </div>
  <%
			...
			<form action=UpdateMovieDetails method="post">
				...
				<div class="form-group">
					...
					<label for="username">Movie Id:</label> <input required
						class="form-control" value="${toEditDetails.getMovieDetailsId()}" readonly name="Id"
						id="username" type="text">
				</div>
				<div class="form-group">
					<label for="email">Story:</label> <textarea required
						class="form-control" rows="4" cols="50" name="story" 
						>${toEditDetails.getStory()}</textarea>
				</div>
				<div class="form-group">
					<label for="password">Release Date:</label> <input required
						class="form-control" value="${toEditDetails.getReleaseDate()}" name="releaseDate" id="password" type="text"
					 >
				</div>
				<div class="form-group">
					<label for="password">Award Name:</label> <input required
						class="form-control" value="${toEditDetails.getAwardName()}" name="awardName"  id="password" type="text"
					 >
				</div>
				<div class="form-group">
					<label for="password">Award Link:</label> <input required
						class="form-control" value="${toEditDetails.getAwardWiki()}" name="awardWiki" id="password" type="text"
					 >
				</div>
				<div class="form-group">

...
<link
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="./assets/after-login/css/topBtn.css"
    />
    <link
      rel="stylesheet"
      type="text/css"
      href="./assets/after-login/css/search.css"
    />
    <link
      rel="stylesheet"
      type="text/css"
      href="./assets/after-login/css/movie.css"
    />
 ...
 <!-- footer page -->
    <div class="footer">
      ...
      <ol class="quick">
        ...
        <a class="last" href="./after-login/index.html">Home</a>
        <a class="last" href="./after-login/watchlist.html">Watchlist</a>
